...
"""Prototype of restricted-SMOTE v2"""
...
class restrictedSMOTE2(BaseOverSampler):
    ...
    def _generate_sample(self, X_big, X_small, row, step):
        ...
        """
        return X_big[row, :] - step * (X_big[row, :] - X_small[row, :])
