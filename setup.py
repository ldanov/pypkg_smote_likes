...
from smote_likes._version import __version__
...
__PROJECT_NAME__ = 'smote_likes'
__DESCRIPTION__ = 'SMOTE-like algorithms for synthetic data generation'
__AUTHORS__ = 'Lyubomir Danov'
__URL__ = 'https://github.com/ldanov/pypkg_smote_likes'
